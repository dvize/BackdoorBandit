...
class Mod implements IPostDBLoadMod {
    ...
    public postDBLoad(container: DependencyContainer): void {
        ...
        this.itemsJson = this.jsonUtil.deserializeJsonC<ItemsJson>(fileSystem.read(itemsJsonPath));
        ...
        const customRecipes = this.jsonUtil.deserializeJsonC<IHideoutProduction[]>(fileSystem.read(path.resolve(__dirname, "../database/templates/craftingItem.jsonc")));
